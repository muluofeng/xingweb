...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="assets/cdn/css/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="assets/cdn/css/ionicons.min.css">
    <!-- Theme style -->
    ...
    <!--[if lt IE 9]>
    <script src="assets/cdn/js/html5shiv.min.js"></script>
    <script src="assets/cdn/js/respond.min.js"></script>
    <![endif]-->
</head>
...
<!-- Morris.js charts -->
<script src="assets/cdn/js/raphael-min.js"></script>
